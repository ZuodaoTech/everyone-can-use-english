...
![installJL-2](installJupyterLab-IMG/installJL-2.png)

![installJL-3](installJupyterLab-IMG/installJL-3.png)

确认无误再点击 Install 安装：

![installJL-4](installJupyterLab-IMG/installJL-4.png)

> 在安装过程的最后一小段，电脑反应可能会变慢，感觉好像是卡住了，无需紧张，静静等待就好，因为安装过程中会执行各种解压、下载和安装命令。

当出现 Completed 字样，说明安装成功，我们 Next ：

![installJL-6](installJupyterLab-IMG/installJL-5.png)

最后 Finish 的时候记得取消这个对勾：

![installJL-6](installJupyterLab-IMG/installJL-6.png)
...
![installJL-7](installJupyterLab-IMG/installJL-7.png)

Anaconda Navigator 提示有新版本，点击 No, remind me later 暂不升级：

![installJL-8](installJupyterLab-IMG/installJL-8.png)

> 如果你对你的网络很有信心，你也可以现在升级，无论你是否升级，都不影响后续操作

点击窗口左侧的 Environments 进入环境配置：

![installJL-9](installJupyterLab-IMG/installJL-9.png)

点击屏幕左下部分的 Create 按钮，新建一个新的 Python 环境，专门用于英语训练：

![installJL-10](installJupyterLab-IMG/installJL-10.png)

> 尽可能不要破坏系统的 Python 环境，以防其他使用Python 的 APP 出问题

在弹出的对话框中，在 Name 这一行输入这个虚拟环境的名称  EnTrainEVM ：

![installJL-11](installJupyterLab-IMG/installJL-11.png)
...
![installJL-12](installJupyterLab-IMG/installJL-12.png)
...
![installJL-13](installJupyterLab-IMG/installJL-13.png)
...
![installJL-17](installJupyterLab-IMG/installJL-17.png)

![installJL-18](installJupyterLab-IMG/installJL-19.png)
...
![installJL-15](installJupyterLab-IMG/installJL-15.png)

点击我同意，安装立即开始

![installJL-14](installJupyterLab-IMG/installJL-14.png)
...
![installJL-16](installJupyterLab-IMG/installJL-16.png)

我们点击 Open Folder 打开文件夹，找到存放学习资料的地方，点击 Open：

![installJL-21](installJupyterLab-IMG/installJL-21.png)

在窗口的右上方，有一个蓝色的图标，点一下：

![installJL-23](installJupyterLab-IMG/installJL-23.png)

在弹出的菜单里，选择我们刚才创建的 EnTrainEVM 英语练习环境：

![installJL-24](installJupyterLab-IMG/installJL-24.png)

看到这个画面需要稍微等一下：

![installJL-25](installJupyterLab-IMG/installJL-25.png)

当你看到这个画面，说明 JupyterLab Desktop 已经安装成功啦！

![installJL-26](installJupyterLab-IMG/installJL-26.png)
