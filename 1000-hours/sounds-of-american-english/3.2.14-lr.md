...
注意，`/ʌl/` 没有 `ə` 的加音，因为 `ʌ` 和 `ə` 原本就非常相近。比如，*ultimate* `/ˈʌltɪmət/`。另外，在自然语音中，`/iːl/` 要注意。比如， reveal 的确读做 `/rɪˈviːəl/`，有加音 `ə`，但，revealing，读作 `/rɪˈviːlɪŋ/`，没有加音 `ə`，可能是因为 `l` 被挪到后面和 `ɪŋ` 构成了第三个音节 `/lɪŋ/`……
