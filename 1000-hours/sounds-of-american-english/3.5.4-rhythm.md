...
The key point is that attractive speech has *rhythm*. The speaker put `ˈ/hiə·(æ)t̬ɑ(ʊə)ˌjunə` into one beat, then started the next beat with the stressed syllable `ˈvəː`: `ˈ/hiə·(æ)t̬ɑ(ʊə)ˌjunə | ˈvəː(r)sət̬i/`...
